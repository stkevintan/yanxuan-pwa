...
const {encodingMethods, compressOptions} = require('../util/compressConf');
...
module.exports = () => {
  let {filter = compressible, threshold = 1024} = compressOptions;
  ...
  return async (ctx, next) => {
    ...
    const stream = ctx.body = encodingMethods[encoding](compressOptions);
