...
<style lang="scss" scoped>
    ...
    .bar-left-item {
        width: px2rem(25);
        height: px2rem(25);
        background-image: url('https://ols1thqnl.qnssl.com/hd-s73530eadc0-9757196115.png');
    ...
    .bar-title {
        width: px2rem(86);
        height: px2rem(27);
        background: url('https://ols1thqnl.qnssl.com/hd-s73530eadc0-9757196115.png') no-repeat;
